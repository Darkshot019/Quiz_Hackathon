...
//        choose_branch = findViewById(R.id.choose_branch);
                            ...
                            if (!phnNo_.isEmpty()) {
                                ...
                                if (!password_.isEmpty()) {
                                    ...
                                    if (email_.matches("[a-zA-Z0-9_!#$%&’*+/=?`{|}~^.-]+@[a-zA-Z0-9.-]+$")) {
                                        ...
                                        reference = firebaseDatabase.getReference("teacherdata");
                                        ...
                                        Intent intend = new Intent(getApplicationContext(), TeacherDashboardActivity.class);
